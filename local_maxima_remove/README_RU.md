...
Перейдите в класс [LocalMaximaRemove](src/main/java/com/epam/training/student_valentyna_leleko/local_maxima_remove/LocalMaximaRemove.java) и реализуйте метод `removeLocalMaxima`.
