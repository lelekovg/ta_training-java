...
Перейдите к классу  [Snail](/com/epam/training/student_valentyna_leleko/snail/Snail.java) и напишите программу с подсчетом количества дней, которые потребуются улитке, чтобы добраться до вершины дерева.
