...
Перейдите в класс  [GoDutch](src/main/java/com/epam/training/student_valentyna_leleko/godutch/GoDutch.java) и напишите программу, которая считывает общую сумму счета и количество друзей, а затем выводит размер части оплаты.
