...
### Описание
Перейдите в класс [SumOfPrevious](src/main/java/com/epam/training/student_valentyna_leleko/sum_of_previous/SumOfPrevious.java) и реализуйте метод `getSumCheckArray`.
